...
<html>
	...
	<body>
		...
		<d:grid id="roleGrid" title="角色列表" height="365" isCellEditable="isCellEditable" queryForm="queryForm" queryUrl="sys/role.do!query" autoQuery="true" >
			<d:toolBar>
			...
			<d:columns>
				<d:column name="role_code" sortable="true" upper="true" required="true" editor="textfield" prompt="角色编号" width="130" />
